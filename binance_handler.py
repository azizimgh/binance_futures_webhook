...
from binance.enums import ORDER_TYPE_LIMIT, FUTURE_ORDER_TYPE_LIMIT_MAKER,FUTURE_ORDER_TYPE_TAKE_PROFIT,FUTURE_ORDER_TYPE_TAKE_PROFIT_MARKET,FUTURE_ORDER_TYPE_STOP,ORDER_TYPE_STOP_LOSS, SIDE_BUY, SIDE_SELL, TIME_IN_FORCE_GTC,ORDER_TYPE_TAKE_PROFIT, ORDER_TYPE_MARKET,ORDER_TYPE_STOP_LOSS_LIMIT
import math
import pandas as pd
...
class binance_handler:
    ...
    def get_and_close_open_position(self,ticker,side_new=""):
        try:
